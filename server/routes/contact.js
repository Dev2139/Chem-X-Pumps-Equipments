...
// POST /api/contact - Handle website form submissions
  ...
  try {
    ...
    if (!email || (!name && !company)) {
      return res.status(400).json({ 
        success: false, 
        message: 'Please provide a valid contact name and email address.' 
      });
    }
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden; background-color: #ffffff;">
        ...
        <div style="padding: 24px; color: #334155; line-height: 1.6;">
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            <tr>
              <td style="padding: 8px 0; border-bottom: 1px solid #f1f5f9; font-weight: bold; width: 140px; color: #0b1e36;">Name:</td>
              <td style="padding: 8px 0; border-bottom: 1px solid #f1f5f9;">${name || 'N/A'}</td>
            </tr>
            ${company ? `
            <tr>
              <td style="padding: 8px 0; border-bottom: 1px solid #f1f5f9; font-weight: bold; color: #0b1e36;">Company:</td>
              <td style="padding: 8px 0; border-bottom: 1px solid #f1f5f9;">${company}</td>
            </tr>` : ''}
            <tr>
              <td style="padding: 8px 0; border-bottom: 1px solid #f1f5f9; font-weight: bold; color: #0b1e36;">Email:</td>
            ...
            <tr>
              <td style="padding: 8px 0; border-bottom: 1px solid #f1f5f9; font-weight: bold; color: #0b1e36;">Phone:</td>
            ...
            ${product ? `
            <tr>
              <td style="padding: 8px 0; border-bottom: 1px solid #f1f5f9; font-weight: bold; color: #0b1e36;">Product/Equipment:</td>
          ...
          <div style="background-color: #f8fafc; border-left: 4px solid #0b1e36; padding: 16px; margin-top: 15px; border-radius: 4px;">
            <p style="margin: 0 0 6px 0; font-weight: bold; font-size: 13px; text-transform: uppercase; color: #64748b;">Customer Message:</p>
    ...
    console.log(`✔ [Nodemailer] Form response sent to ${receiverEmail} (MsgID: ${info.messageId})`);
